...
public class ApplicationDbContext : DbContext
{
    ...
    public DbSet<CustomerOrder> WithdrawalOrders { get; set; }
    public DbSet<CustomerOrderDetail> WithdrawalOrderDetails { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CustomerOrderDetail>().HasKey(wd => new { wd.WithdrawalOrderID, wd.ItemID });
